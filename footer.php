        ...
        <div class="reply">
            <div class="reply__body">
                <div class="reply__title">
                  ...
                  <?php echo do_shortcode( '[contact-form-7 id="172" title="Попап форм"]' )?>
            </div>
        </div>
        <footer>
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a target="_blank" href="<?php the_field('instagram', 2); ?>" class="footer__social-item">
                            ...
                            <a target="_blank" href="<?php the_field('facebook', 2); ?>" class="footer__social-item">
                            ...
                            <a target="_blank" href="<?php the_field('youtube', 2); ?>" class="footer__social-item">
                    ...
                    <div class="col-md-8 offset-md-0 col-lg-6 col-xl-5 offset-xl-1">
                        <div class="footer__contacts">
                            ...
                            <div class="footer__contacts-item">
                                ...
                                <address><?php the_field('location_adress', 2); ?></address>
                            </div>
                        </div>
                    </div>
                </div>
